...
extern const u32 gMonStillFrontPic_Voltrel[];
...
extern const u32 gMonStillFrontPic_Voltrean[];
...
extern const u32 gMonPalette_Psychu[];
extern const u32 gMonBackPic_Psychu[];
extern const u32 gMonShinyPalette_Psychu[];
extern const u32 gMonStillFrontPic_Psychu[];
...
extern const u32 gMonPalette_Raelic[];
extern const u32 gMonBackPic_Raelic[];
extern const u32 gMonShinyPalette_Raelic[];
extern const u32 gMonStillFrontPic_Raelic[];
extern const u8 gMonIcon_Raelic[];
extern const u8 gMonFootprint_Raelic[];
extern const u32 gMonFrontPic_Romushu[];
extern const u32 gMonPalette_Romushu[];
extern const u32 gMonBackPic_Romushu[];
extern const u32 gMonShinyPalette_Romushu[];
extern const u32 gMonStillFrontPic_Romushu[];
extern const u8 gMonIcon_Romushu[];
extern const u8 gMonFootprint_Romushu[];
extern const u32 gMonFrontPic_Fusang[];
extern const u32 gMonPalette_Fusang[];
extern const u32 gMonBackPic_Fusang[];
extern const u32 gMonShinyPalette_Fusang[];
extern const u32 gMonStillFrontPic_Fusang[];
...
extern const u32 gMonFrontPic_Fletchadin[];
extern const u32 gMonPalette_Fletchadin[];
extern const u32 gMonBackPic_Fletchadin[];
extern const u32 gMonShinyPalette_Fletchadin[];
extern const u32 gMonStillFrontPic_Fletchadin[];
extern const u8 gMonIcon_Fletchadin[];
extern const u8 gMonFootprint_Fletchadin[];
...
extern const u32 gMonStillFrontPic_Mlloy[];
...
extern const u32 gMonPalette_Purgislug[];
extern const u32 gMonBackPic_Purgislug[];
extern const u32 gMonShinyPalette_Purgislug[];
extern const u32 gMonStillFrontPic_Purgislug[];
...
extern const u32 gMonPalette_Larvicid[];
extern const u32 gMonBackPic_Larvicid[];
extern const u32 gMonShinyPalette_Larvicid[];
extern const u32 gMonStillFrontPic_Larvicid[];
extern const u8 gMonIcon_Larvicid[];
extern const u8 gMonFootprint_Larvicid[];
extern const u32 gMonFrontPic_Pendragon[];
extern const u32 gMonPalette_Pendragon[];
extern const u32 gMonBackPic_Pendragon[];
extern const u32 gMonShinyPalette_Pendragon[];
extern const u32 gMonStillFrontPic_Pendragon[];
...
extern const u32 gMonStillFrontPic_Krolucada[];
...
extern const u32 gMonStillFrontPic_Krolucard[];
...
extern const u32 gMonStillFrontPic_Dundrag[];
...
extern const u32 gMonStillFrontPic_Dunlong[];
...
extern const u32 gMonStillFrontPic_Flittle[];
...
extern const u32 gMonStillFrontPic_Espathra[];
...
extern const u32 gMonFrontPic_DarmanitanTrance[];
extern const u32 gMonPalette_DarmanitanTrance[];
extern const u32 gMonBackPic_DarmanitanTrance[];
extern const u32 gMonShinyPalette_DarmanitanTrance[];
extern const u32 gMonStillFrontPic_DarmanitanTrance[];
extern const u8 gMonIcon_DarmanitanTrance[];
extern const u8 gMonFootprint_DarmanitanTrance[];
...
extern const u32 gMonStillFrontPic_Gemgeist[];
...
extern const u32 gMonStillFrontPic_Bitemare[];
...
extern const u32 gMonFrontPic_MeganiumAlt[];
extern const u32 gMonPalette_MeganiumAlt[];
extern const u32 gMonBackPic_MeganiumAlt[];
extern const u32 gMonShinyPalette_MeganiumAlt[];
extern const u32 gMonStillFrontPic_MeganiumAlt[];
extern const u8 gMonIcon_MeganiumAlt[];
extern const u8 gMonFootprint_MeganiumAlt[];

extern const u32 gMonFrontPic_TyphlosionAlt[];
extern const u32 gMonPalette_TyphlosionAlt[];
extern const u32 gMonBackPic_TyphlosionAlt[];
extern const u32 gMonShinyPalette_TyphlosionAlt[];
extern const u32 gMonStillFrontPic_TyphlosionAlt[];
extern const u8 gMonIcon_TyphlosionAlt[];
extern const u8 gMonFootprint_TyphlosionAlt[];

extern const u32 gMonFrontPic_FeraligatrAlt[];
extern const u32 gMonPalette_FeraligatrAlt[];
extern const u32 gMonBackPic_FeraligatrAlt[];
extern const u32 gMonShinyPalette_FeraligatrAlt[];
extern const u32 gMonStillFrontPic_FeraligatrAlt[];
extern const u8 gMonIcon_FeraligatrAlt[];
extern const u8 gMonFootprint_FeraligatrAlt[];

extern const u32 gMonFrontPic_Ramnarok[];
extern const u32 gMonPalette_Ramnarok[];
extern const u32 gMonBackPic_Ramnarok[];
extern const u32 gMonShinyPalette_Ramnarok[];
extern const u32 gMonStillFrontPic_Ramnarok[];
extern const u8 gMonIcon_Ramnarok[];
extern const u8 gMonFootprint_Ramnarok[];

extern const u32 gMonFrontPic_RamnarokRadiant[];
extern const u32 gMonPalette_RamnarokRadiant[];
extern const u32 gMonBackPic_RamnarokRadiant[];
extern const u32 gMonShinyPalette_RamnarokRadiant[];
extern const u32 gMonStillFrontPic_RamnarokRadiant[];
extern const u8 gMonIcon_RamnarokRadiant[];
extern const u8 gMonFootprint_RamnarokRadiant[];
...
extern const u32 gTrainerFrontPic_GuitaristM[];
...
extern const u32 gTrainerPalette_GuitaristM[];
...
extern const u8 gTrainerBackPic_Silver[];
extern const u32 gTrainerPalette_Silver_Back[];
extern const u8 gTrainerBackPic_Lance[];
extern const u32 gTrainerPalette_Lance_Back[];
...
extern const u32 gIntroFusangSilhouette_Gfx[];
...
extern const u32 gIntroKrolucada_Gfx[];
extern const u16 gIntroKrolucada_Pal[];
...
extern const u16 gIntroFusang_Pal[];
extern const u32 gIntroFusang_Gfx[];
...
//extern const u32 gWallpaperIcon_Fletchling[];
...
extern const u32 gTrainerFrontPic_SkierF[];
extern const u32 gTrainerFrontPic_SkierM[];
extern const u32 gTrainerFrontPic_Gambler[];
extern const u32 gTrainerFrontPic_Gideon[];
extern const u32 gTrainerFrontPic_MasterYama[];
...
extern const u32 gTrainerFrontPic_GuitaristF[];
extern const u32 gTrainerFrontPic_Buck[];
extern const u32 gTrainerFrontPic_Lorelei[];
extern const u32 gTrainerFrontPic_Agatha[];
extern const u32 gTrainerFrontPic_Riley[];
...
extern const u32 gTrainerFrontPic_Sora[];
extern const u32 gTrainerFrontPic_SoraWithCat[];
...
extern const u32 gTrainerPalette_SkierF[];
extern const u32 gTrainerPalette_SkierM[];
extern const u32 gTrainerPalette_Gambler[];
extern const u32 gTrainerPalette_Gideon[];
extern const u32 gTrainerPalette_MasterYama[];
...
extern const u32 gTrainerPalette_GuitaristF[];
extern const u32 gTrainerPalette_Buck[];
extern const u32 gTrainerPalette_Lorelei[];
extern const u32 gTrainerPalette_Agatha[];
extern const u32 gTrainerPalette_Riley[];
...
extern const u32 gTrainerPalette_Sora[];
extern const u32 gTrainerPalette_SoraWithCat[];
