...
extern const u32 gMonFrontPic_Lotuga[];
extern const u32 gMonPalette_Lotuga[];
extern const u32 gMonBackPic_Lotuga[];
extern const u32 gMonShinyPalette_Lotuga[];
extern const u32 gMonStillFrontPic_Lotuga[];
extern const u8 gMonIcon_Lotuga[];
extern const u8 gMonFootprint_Lotuga[];
extern const u32 gMonFrontPic_Vertuga[];
extern const u32 gMonPalette_Vertuga[];
extern const u32 gMonBackPic_Vertuga[];
extern const u32 gMonShinyPalette_Vertuga[];
extern const u32 gMonStillFrontPic_Vertuga[];
extern const u8 gMonIcon_Vertuga[];
extern const u8 gMonFootprint_Vertuga[];
...
extern const u32 gTrainerFrontPic_Model[];
...
extern const u32 gTrainerPalette_Model[];
