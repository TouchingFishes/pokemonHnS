...
#define TUTOR_MOVE_MIMIC           33 //Tri Attack
#define TUTOR_MOVE_METRONOME       8
#define TUTOR_MOVE_SOFT_BOILED     9
#define TUTOR_MOVE_DREAM_EATER     10 //Curse
...
#define TUTOR_MOVE_DYNAMIC_PUNCH   15 //Focus Punch
...
#define TUTOR_MOVE_ICE_PUNCH       22 //Ice Ball
#define TUTOR_MOVE_SWAGGER         23
#define TUTOR_MOVE_SLEEP_TALK      24 //Acrobatics
#define TUTOR_MOVE_SWIFT           25 //Zen Headbutt
#define TUTOR_MOVE_DEFENSE_CURL    26
#define TUTOR_MOVE_THUNDER_PUNCH   27 //Psycho Cut
#define TUTOR_MOVE_FIRE_PUNCH      28 //Fissure
