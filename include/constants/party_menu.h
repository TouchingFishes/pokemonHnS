...
#define TUTOR_MOVE_FOCUS_PUNCH     15
...
#define TUTOR_MOVE_ZEN_HEADBUTT    25
#define TUTOR_MOVE_DEFENSE_CURL    26
#define TUTOR_MOVE_POISON_JAB      27
#define TUTOR_MOVE_FISSURE         28
