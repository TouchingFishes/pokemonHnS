...
extern const u8 gText_EVO_LEVEL_MORGREM[];
extern const u8 gText_EVO_LEVEL_ROSELIA[];
...
extern const u8 gTrickHouse_Mechadoll_Vanillite[];
extern const u8 gTrickHouse_Mechadoll_Lotad[];
extern const u8 gTrickHouse_Mechadoll_Rufflet[];
extern const u8 gTrickHouse_Mechadoll_Roserade[];
...
extern const u8 gText_GrassMoveChoice[];
extern const u8 gText_FireMoveChoice[];
extern const u8 gText_WaterMoveChoice[];
extern const u8 gText_DeclineUltimateMoveChoice[];
