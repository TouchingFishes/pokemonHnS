...
static const struct PokemonJumpMons sPokeJumpMons[] =
{
    ...
    { .species = SPECIES_MORGREM,    .jumpType = JUMP_TYPE_SLOW, },
    ...
    { .species = SPECIES_GOTHITA,      .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_GOTHORITA,     .jumpType = JUMP_TYPE_NORMAL, },
    ...
    { .species = SPECIES_AXEW,    .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_SOLOSIS,    .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_SKITTY,     .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_MIMIKYU,    .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_TALONFLAME,     .jumpType = JUMP_TYPE_NORMAL, },
    ...
    { .species = SPECIES_FLETCHLING,     .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_FLETCHADIN,      .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_KROLUCADA,    .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_KROLUCARD,   .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_PURGISLUG,    .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_LARVICID,     .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_NUMEL,      .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_TORKOAL,    .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_DUOSION,     .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_RAELIC,   .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_PAWNIARD,     .jumpType = JUMP_TYPE_SLOW, },
