...
static const struct PokemonJumpMons sPokeJumpMons[] =
{
    ...
    { .species = SPECIES_VANILLITE,    .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_SKITTY,     .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_GALLADE,    .jumpType = JUMP_TYPE_NORMAL, },
    ...
    { .species = SPECIES_VANILLISH,     .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_RAELIC,   .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_BRONZOR,     .jumpType = JUMP_TYPE_SLOW, },
