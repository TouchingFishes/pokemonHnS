...
// Valuable items
    ...
    [ITEM_BIG_MUSHROOM] =
    {
        ...
        .holdEffectParam = 16,      // heals maxHP/16 per turn, same as Leftovers
...
// Berries
    ...
    [ITEM_RAZZ_BERRY] =
    {
        ...
        .price = 20,
        .holdEffect = HOLD_EFFECT_TYPE_RESIST,
...
// Emerald-specific key items
    ...
    [ITEM_BLACK_SLUDGE] =
    {
        ...
        .holdEffectParam = 16,      // POISON heals maxHP/16; other lose maxHP/8
    ...
    [ITEM_WEAKNESS_POLICY] =
    {
        ...
        .holdEffectParam = 1,      // stat stages gained
    ...
    [ITEM_EVIOLITE] =
    {
        ...
        .holdEffectParam = 50,       // +50% Def and Sp.Def
    ...
    [ITEM_LIGHT_CLAY] =
    {
        ...
        .holdEffectParam = 8,      // screen turns
    ...
    [ITEM_ICY_ROCK] =
    {
        ...
        .holdEffectParam = 8,      // weather turns
    ...
    [ITEM_STARLIT_SHARD] =
    {
        .name = _("STARLIT SHARD"),
        .itemId = ITEM_STARLIT_SHARD,
        .price = 0,             // unsellable
        .description = sStarlitShardDesc,
        .pocket = POCKET_ITEMS,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_EvolutionStone,
    },
