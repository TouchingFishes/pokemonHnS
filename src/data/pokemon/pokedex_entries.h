const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_DARMANITAN_TRANCE] =
    {
        .categoryName = _("ZEN"),
        .height = 13,
        .weight = 929,
        .description = gDarmanitanTrancePokedexText,
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_RAMNAROK] =
    {
        .categoryName = _("AURORA"),
        .height = 21,
        .weight = 2000,
        .description = gRamnarokPokedexText,
        .pokemonScale = 259,
        .pokemonOffset = -2,
        .trainerScale = 345,
        .trainerOffset = 7,
