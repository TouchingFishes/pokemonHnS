const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_SCYTHER]    = {{EVO_ITEM_HOLD, ITEM_METAL_COAT, SPECIES_SCIZOR},
                           {EVO_LEVEL_LOCATION, MAPSEC_MT_SILVER, SPECIES_AEGISLASH},
                           {EVO_LEVEL_LOCATION, MAPSEC_VICTORY_ROAD, SPECIES_AEGISLASH}},
    ...
    [SPECIES_FLOETTE]    = {{EVO_LEVEL, 48, SPECIES_FLORGES}},
    [SPECIES_LOTUGA]     = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_VERTUGA}},
    ...
    [SPECIES_RAELIC]   = {{EVO_LEVEL, 35, SPECIES_ROMUSHU}},
    [SPECIES_ROMUSHU]    = {{EVO_LEVEL, 45, SPECIES_FUSANG}},
    ...
    [SPECIES_DUNSPARCE]  = {{EVO_LEVEL, 65, SPECIES_DUNLONG}},
    [SPECIES_STANTLER]   = {{EVO_MOVE, MOVE_PSYCHO_CUT, SPECIES_WYRDEER}},
    [SPECIES_URSARING]   = {{EVO_LEVEL_NIGHT, 42, SPECIES_HONEDGE},
                            {EVO_LEVEL_LOCATION, MAPSEC_MT_MOON, SPECIES_DOUBLADE}},
