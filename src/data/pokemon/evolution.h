const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PRIMEAPE]   = {{EVO_LEVEL_NIGHT, 44, SPECIES_KUJINOUGHT}},
    ...
    [SPECIES_LICKITUNG]  = {{EVO_MOVE, MOVE_ROLLOUT, SPECIES_GEKOPON}},
    [SPECIES_KOFFING]    = {{EVO_LEVEL, 35, SPECIES_WEEZING}},
    [SPECIES_RHYHORN]    = {{EVO_LEVEL, 42, SPECIES_RHYDON}},
    [SPECIES_RHYDON]     = {{EVO_ITEM_HOLD, ITEM_METAL_COAT, SPECIES_SNOVER}},
    ...
    [SPECIES_TOGETIC]    = {{EVO_ITEM_HOLD_DAY, ITEM_HEART_SCALE, SPECIES_CORSOREEF}},
    ...
    [SPECIES_AIPOM]      = {{EVO_MOVE, MOVE_TICKLE, SPECIES_DECIBELLE}},
    ...
    [SPECIES_PILOSWINE]  = {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_LARVESTA}},
    ...
    [SPECIES_PORYGON2]   = {{EVO_ITEM_HOLD, ITEM_UP_GRADE, SPECIES_HYDREIGON}},
    ...
    [SPECIES_IMPIDIMP]    = {{EVO_LEVEL_MORGREM, 7, SPECIES_MORGREM},
                            {EVO_LEVEL_FLABEBE, 7, SPECIES_FLABEBE}},
    [SPECIES_MORGREM]    = {{EVO_LEVEL, 10, SPECIES_GRIMMSNARL}},
    [SPECIES_FLABEBE]    = {{EVO_LEVEL, 10, SPECIES_FLOETTE}},
    [SPECIES_FLORGES]      = {{EVO_LEVEL, 14, SPECIES_LOTUGA}},
    [SPECIES_LOTUGA]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_VERTUGA}},
    ...
    [SPECIES_VOLTREL]    = {{EVO_LEVEL, 22, SPECIES_VOLTREAN}},
    [SPECIES_SHROOMISH]  = {{EVO_LEVEL, 23, SPECIES_BRELOOM}},
    [SPECIES_RUFFLET]    = {{EVO_LEVEL, 25, SPECIES_BRAVIARY}},
    ...
    [SPECIES_NOSEPASS]   = {{EVO_ITEM_HOLD, ITEM_THUNDER_STONE, SPECIES_PORYGON_Z}},
    ...
    [SPECIES_SOLOSIS]    = {{EVO_FRIENDSHIP, 0, SPECIES_MARILL}},
    ...
    [SPECIES_MLLOY]     = {{EVO_LEVEL, 15, SPECIES_WOBBUFFET}},
    [SPECIES_DUSKULL]    = {{EVO_LEVEL, 37, SPECIES_DUSCLOPS}},
    [SPECIES_DUSCLOPS]   = {{EVO_ITEM_HOLD, ITEM_SPELL_TAG, SPECIES_SPIRITOMB}},
    [SPECIES_PURGISLUG]    = {{EVO_BEAUTY, 70, SPECIES_ABOMASNOW}},
    ...
    [SPECIES_TINKATINK]     = {{EVO_MOVE, MOVE_MIMIC, SPECIES_SUDOWOODO}},
    [SPECIES_TINKATUFF]      = {{EVO_FRIENDSHIP, 0, SPECIES_PURGISLUG}},
    [SPECIES_TINKATON]  = {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_CHIMECHO}},
    [SPECIES_HAPPINY]    = {{EVO_ITEM_HOLD, ITEM_HEART_SCALE, SPECIES_CHANSEY}},
    [SPECIES_VOLCARONA]    = {{EVO_MOVE, MOVE_WATER_PULSE, SPECIES_MANTINE}},
    [SPECIES_DEINO]    = {{EVO_MOVE, MOVE_MIMIC, SPECIES_MR_MIME}},
    [SPECIES_ZWEILOUS]   = {{EVO_FRIENDSHIP, 0, SPECIES_SNORLAX}},
    [SPECIES_GIRAFARIG]  = {{EVO_MOVE, MOVE_SIGNAL_BEAM, SPECIES_DUNDRAG}},
    [SPECIES_DUNSPARCE]  = {{EVO_MOVE, MOVE_DRILL_PECK, SPECIES_DUNLONG}},
