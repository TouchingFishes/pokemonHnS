const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]    = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_PSYCHU}},
    ...
    [SPECIES_URSARING]   = {{EVO_LEVEL, 99, SPECIES_URSALUNA}}, //figure out a cool evo method
    ...
    [SPECIES_ROSELIA]    = {{EVO_LEVEL, 48, SPECIES_ROSERADE}},
    [SPECIES_LOTAD]      = {{EVO_LEVEL, 14, SPECIES_LOTAD}},
    ...
    [SPECIES_RAELIC]     = {{EVO_LEVEL, 48, SPECIES_ROMUSHU}},
    [SPECIES_ROMUSHU]    = {{EVO_LEVEL, 64, SPECIES_FUSANG}},
    ...
    [SPECIES_SNORUNT]    = {{EVO_LEVEL, 42, SPECIES_GLALIE},
                            {EVO_ITEM_HOLD_NIGHT, ITEM_SPELL_TAG, SPECIES_FROSLASS}},
    ...
    [SPECIES_LARVICID]   = {{EVO_LEVEL, 38, SPECIES_PENDRAGON}},
    ...
    [SPECIES_DUNSPARCE]  = {{EVO_LEVEL, 45, SPECIES_DUNDRAG}, 
                            {EVO_ITEM_HOLD, ITEM_KINGS_ROCK, SPECIES_DUDUNSPARCE}},
    [SPECIES_DUNDRAG]    = {{EVO_LEVEL, 68, SPECIES_DUNLONG}},
    [SPECIES_STANTLER]   = {{EVO_MOVE, MOVE_PSYCHO_CUT, SPECIES_WYRDEER}},
    [SPECIES_OCTILLERY]  = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_KUJINOUGHT}},
    [SPECIES_FARFETCHD]  = {{EVO_ITEM_HOLD, ITEM_BERRY_JUICE, SPECIES_MLLOY}},
    [SPECIES_CORSOLA]    = {{EVO_FRIENDSHIP, 0, SPECIES_CORSOREEF}},
    [SPECIES_FLETCHLING] = {{EVO_LEVEL, 17, SPECIES_FLETCHADIN}},
    [SPECIES_FLETCHADIN] = {{EVO_LEVEL, 35, SPECIES_TALONFLAME}},
    [SPECIES_KROLUCADA]  = {{EVO_LEVEL, 44, SPECIES_KROLUCARD}},
    ...
    [SPECIES_FOMANTIS]   = {{EVO_ITEM_HOLD, ITEM_MIRACLE_SEED, SPECIES_LURANTIS}},
    ...
    [SPECIES_NOHFACE]    = {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_KITSUNOH}},
    [SPECIES_KLINK]      = {{EVO_LEVEL, 38, SPECIES_KLANG}},
    [SPECIES_KLANG]      = {{EVO_LEVEL, 49, SPECIES_KLINKLANG}},
    [SPECIES_SPOINK]    = {{EVO_LEVEL, 35, SPECIES_GRUMPIG}},
    ...
    [SPECIES_FLITTLE]     = {{EVO_LEVEL, 26, SPECIES_ESPATHRA}},
    ...
    [SPECIES_BOLDORE]    = {{EVO_LEVEL, 47, SPECIES_GIGALITH}},
    ...
    [SPECIES_LAMPENT]    = {{EVO_LEVEL, 56, SPECIES_CHANDELURE}},
