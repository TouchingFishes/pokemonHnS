const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_GUITARIST_M] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_GIDEON] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_MASTER_YAMA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_ROCKER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_CASINO_ACE] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_PAINTER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_TAMER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_SCIENTIST] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_MODEL] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_GUITARIST_F] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_BUCK] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_IRIS] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_ALDER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_CYNTHIA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_SORA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_SORA_WITH_CAT] = {.size = 8, .y_offset = 1},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(GUITARIST_M, gTrainerFrontPic_GuitaristM, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(SKIER_F, gTrainerFrontPic_SkierF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SKIER_M, gTrainerFrontPic_SkierM, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(GAMBLER, gTrainerFrontPic_Gambler, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(GIDEON, gTrainerFrontPic_Gideon, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(MASTER_YAMA, gTrainerFrontPic_MasterYama, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ROCKER, gTrainerFrontPic_Rocker, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CASINO_ACE, gTrainerFrontPic_CasinoAce, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(MODEL, gTrainerFrontPic_Model, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(GUITARIST_F, gTrainerFrontPic_GuitaristF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BUCK, gTrainerFrontPic_Buck, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(PALMER, gTrainerFrontPic_Palmer, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BARRY, gTrainerFrontPic_Barry, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(IRIS, gTrainerFrontPic_Iris, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ALDER, gTrainerFrontPic_Alder, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CYNTHIA, gTrainerFrontPic_Cynthia, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SORA, gTrainerFrontPic_Sora, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SORA_WITH_CAT, gTrainerFrontPic_SoraWithCat, TRAINER_PIC_SIZE),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(GUITARIST_M, gTrainerPalette_GuitaristM),
    ...
    TRAINER_PAL(SKIER_F, gTrainerPalette_SkierF),
    TRAINER_PAL(SKIER_M, gTrainerPalette_SkierM),
    TRAINER_PAL(GAMBLER, gTrainerPalette_Gambler),
    TRAINER_PAL(GIDEON, gTrainerPalette_Gideon),
    TRAINER_PAL(MASTER_YAMA, gTrainerPalette_MasterYama),
    ...
    TRAINER_PAL(MODEL, gTrainerPalette_Model),
    TRAINER_PAL(GUITARIST_F, gTrainerPalette_GuitaristF),
    TRAINER_PAL(BUCK, gTrainerPalette_Buck),
    ...
    TRAINER_PAL(ALDER, gTrainerPalette_Alder),
    TRAINER_PAL(CYNTHIA, gTrainerPalette_Cynthia),
    TRAINER_PAL(SORA, gTrainerPalette_Sora),
    TRAINER_PAL(SORA_WITH_CAT, gTrainerPalette_SoraWithCat),
};
