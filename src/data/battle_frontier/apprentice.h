...
{
    {
        ...
        .species = {SPECIES_BEAUTIFLY, SPECIES_DUSTOX, SPECIES_KROLUCARD, SPECIES_SHIFTRY, SPECIES_BRELOOM, SPECIES_NINJASK, SPECIES_SHEDINJA, SPECIES_PINSIR, SPECIES_HERACROSS, SPECIES_KROLUCADA},
        .id = 0,
