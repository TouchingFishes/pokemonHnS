...
{
    {
        ...
        .species = {SPECIES_GRIMMSNARL, SPECIES_ROSERADE, SPECIES_KROLUCARD, SPECIES_SHIFTRY, SPECIES_BRELOOM, SPECIES_NINJASK, SPECIES_SHEDINJA, SPECIES_PINSIR, SPECIES_HERACROSS, SPECIES_KROLUCADA},
        .id = 0,
    ...
    },
    {
        ...
        .species = {SPECIES_VOLTREAN, SPECIES_PENDRAGON, SPECIES_SHUCKLE, SPECIES_MANECTRIC, SPECIES_TORKOAL, SPECIES_HARIYAMA, SPECIES_MIGHTYENA, SPECIES_LUDICOLO, SPECIES_CRAWDAUNT, SPECIES_WHISCASH},
        .id = 1,
    ...
    },
    {
        ...
        .species = {SPECIES_LINOONE, SPECIES_MIGHTYENA, SPECIES_WHISCASH, SPECIES_DRAPION, SPECIES_SKORUPI, SPECIES_NINETALES, SPECIES_PSYCHU, SPECIES_SHUCKLE, SPECIES_MANECTRIC, SPECIES_MACHAMP},
        .id = 2,
    ...
    },
    {
        ...
        .species = {SPECIES_PENDRAGON, SPECIES_XATU, SPECIES_ALTARIA, SPECIES_GOLDUCK, SPECIES_FUSANG, SPECIES_ALAKAZAM, SPECIES_GOTHITELLE, SPECIES_WAILORD, SPECIES_REUNICLUS, SPECIES_MIGHTYENA},
        .id = 3,
    ...
    },
    {
        ...
        .species = {SPECIES_WIGGLYTUFF, SPECIES_LINOONE, SPECIES_KINGDRA, SPECIES_DELCATTY, SPECIES_RAICHU, SPECIES_FEAROW, SPECIES_STARMIE, SPECIES_MEDICHAM, SPECIES_SHIFTRY, SPECIES_GRIMMSNARL},
        .id = 4,
    ...
    },
    {
        ...
        .species = {SPECIES_STARMIE, SPECIES_DODRIO, SPECIES_AGGRON, SPECIES_MAGNETON, SPECIES_MACHAMP, SPECIES_ARMALDO, SPECIES_HERACROSS, SPECIES_NOSEPASS, SPECIES_HAXORUS, SPECIES_MIGHTYENA},
        .id = 5,
    ...
    },
    {
        ...
        .species = {SPECIES_STARMIE, SPECIES_DODRIO, SPECIES_MAGNETON, SPECIES_MEDICHAM, SPECIES_MIGHTYENA, SPECIES_GLALIE, SPECIES_GOLEM, SPECIES_ELECTRODE, SPECIES_BRAVIARY, SPECIES_SHARPEDO},
        .id = 6,
    ...
    },
    {
        ...
        .species = {SPECIES_NINETALES, SPECIES_ALAKAZAM, SPECIES_SCEPTILE, SPECIES_GARCHOMP, SPECIES_GOLDUCK, SPECIES_TALONFLAME, SPECIES_WEEZING, SPECIES_LANTURN, SPECIES_GOTHITELLE, SPECIES_MILOTIC},
        .id = 7,
    ...
    },
    {
        ...
        .species = {SPECIES_SCEPTILE, SPECIES_VILEPLUME, SPECIES_BELLOSSOM, SPECIES_PURGISLUG, SPECIES_CORSOLA, SPECIES_FUSANG, SPECIES_BRELOOM, SPECIES_MILOTIC, SPECIES_ALTARIA, SPECIES_CRADILY},
        .id = 8,
    ...
    },
    {
        ...
        .species = {SPECIES_SKARMORY, SPECIES_GOLEM, SPECIES_BLAZIKEN, SPECIES_CAMERUPT, SPECIES_DONPHAN, SPECIES_MUK, SPECIES_GARCHOMP, SPECIES_TROPIUS, SPECIES_SOLROCK, SPECIES_RHYDON},
        .id = 9,
    ...
    },
    {
        ...
        .species = {SPECIES_QUAGSIRE, SPECIES_STARMIE, SPECIES_BRAVIARY, SPECIES_CRAWDAUNT, SPECIES_WAILORD, SPECIES_GYARADOS, SPECIES_SWAMPERT, SPECIES_LANTURN, SPECIES_WHISCASH, SPECIES_SHUCKLE},
        .id = 11,
    ...
    },
    {
        ...
        .species = {SPECIES_ABSOL, SPECIES_CROBAT, SPECIES_HAXORUS, SPECIES_MAGNETON, SPECIES_SHARPEDO, SPECIES_MANECTRIC, SPECIES_METAGROSS, SPECIES_ELECTRODE, SPECIES_NOSEPASS, SPECIES_WEEZING},
        .id = 12,
    ...
    },
    {
        ...
        .species = {SPECIES_BLAZIKEN, SPECIES_GOLEM, SPECIES_MACHAMP, SPECIES_RHYDON, SPECIES_HARIYAMA, SPECIES_AGGRON, SPECIES_MEDICHAM, SPECIES_DRAPION, SPECIES_VIGOROTH, SPECIES_SLAKING},
        .id = 13,
    ...
    },
    {
        ...
        .species = {SPECIES_SCEPTILE, SPECIES_SANDSLASH, SPECIES_FUSANG, SPECIES_CLAYDOL, SPECIES_ARMALDO, SPECIES_CROBAT, SPECIES_CRADILY, SPECIES_SOLROCK, SPECIES_LUNATONE, SPECIES_GOLEM},
        .id = 14,
    ...
    },
    {
        ...
        .species = {SPECIES_ABSOL, SPECIES_MIGHTYENA, SPECIES_ALAKAZAM, SPECIES_BANETTE, SPECIES_NINETALES, SPECIES_CLAYDOL, SPECIES_MUK, SPECIES_GARCHOMP, SPECIES_EELEKTROSS, SPECIES_DUSCLOPS},
        .id = 15,
...
static const bool8 sValidApprenticeMoves[MOVES_COUNT] =
{
    ...
    [MOVE_PIXIE_KISS] = TRUE,
    [MOVE_FAIRY_SONG] = TRUE,
    [MOVE_MYSTIC_GLEAM] = TRUE,
    [MOVE_GUNK_SHOT] = TRUE,
    [MOVE_STONE_EDGE] = TRUE,
    [MOVE_CHARGE_BEAM] = TRUE,
    [MOVE_NIGHT_SLASH] = TRUE,
    [MOVE_ROCK_WRECKER] = TRUE,
    [MOVE_BURNING_SAND] = TRUE,
    [MOVE_POWER_WHIP] = TRUE,
    [MOVE_WOOD_HAMMER] = TRUE,
    [MOVE_FIERY_DANCE] = TRUE,
    [MOVE_HAMMER_SMASH] = TRUE,
    [MOVE_TWIN_BEAM] = FALSE, //excluded because multihit moves are often false???
    [MOVE_DRAIN_LIFE] = TRUE,
    ...
    [MOVE_SCALD] = TRUE,
    [MOVE_MAGICAL_FIRE] = TRUE,
    [MOVE_WILD_CHARGE] = TRUE,
    [MOVE_BARRIER_BASH] = TRUE,
    [MOVE_GYRO_BALL] = TRUE,
