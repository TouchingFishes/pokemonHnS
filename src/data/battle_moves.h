const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_FOUL_PLAY] =
    {
        .effect = EFFECT_SPEED_UP_HIT, //FOUL_PLAY
        .power = 85, //95
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 15,
