...
{
    [CONTEST_CATEGORY_COOL]   = OBJ_EVENT_GFX_CLEFAIRY_DOLL, //OBJ_EVENT_GFX_ZIGZAGOON_1,
    [CONTEST_CATEGORY_BEAUTY] = OBJ_EVENT_GFX_CLEFAIRY_DOLL, //OBJ_EVENT_GFX_PSYCHU,
    [CONTEST_CATEGORY_CUTE]   = OBJ_EVENT_GFX_CLEFAIRY_DOLL, //OBJ_EVENT_GFX_POOCHYENA,
    [CONTEST_CATEGORY_SMART]  = OBJ_EVENT_GFX_CLEFAIRY_DOLL, //OBJ_EVENT_GFX_PSYCHU,
    [CONTEST_CATEGORY_TOUGH]  = OBJ_EVENT_GFX_CLEFAIRY_DOLL //OBJ_EVENT_GFX_PIKACHU
};
...
static const u16 sContestLadyMonSpecies[] =
{
    ...
    [CONTEST_CATEGORY_SMART]  = SPECIES_PSYCHU,
