const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(PSYCHU, gMonPalette_Psychu),
    ...
    SPECIES_PAL(RAELIC, gMonPalette_Raelic),
    SPECIES_PAL(ROMUSHU, gMonPalette_Romushu),
    SPECIES_PAL(FUSANG, gMonPalette_Fusang),
    ...
    SPECIES_PAL(FLETCHADIN, gMonPalette_Fletchadin),
    ...
    SPECIES_PAL(LARVICID, gMonPalette_Larvicid),
    SPECIES_PAL(PENDRAGON, gMonPalette_Pendragon),
    ...
    SPECIES_PAL(NOHFACE, gMonPalette_Nohface),
    ...
    SPECIES_PAL(DARMANITAN_TRANCE, gMonPalette_DarmanitanTrance),
    ...
    SPECIES_PAL(ALT_MEGANIUM, gMonPalette_MeganiumAlt),
    SPECIES_PAL(ALT_TYPHLOSION, gMonPalette_TyphlosionAlt),
    SPECIES_PAL(ALT_FERALIGATR, gMonPalette_FeraligatrAlt),
    SPECIES_PAL(RAMNAROK, gMonPalette_Ramnarok),
    SPECIES_PAL(RAMNAROK_RADIANT, gMonPalette_RamnarokRadiant),
