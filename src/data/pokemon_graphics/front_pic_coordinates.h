...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_IMPIDIMP]     = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 14 },
    [SPECIES_MORGREM]     = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 17 },
    [SPECIES_GRIMMSNARL]   = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    [SPECIES_FLABEBE]     = { .size = MON_COORDS_SIZE(56, 32), .y_offset = 16 },
    [SPECIES_FLOETTE]      = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 15 },
    [SPECIES_FLORGES]       = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 14 },
    [SPECIES_LOTUGA]      = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  9 },
    [SPECIES_VERTUGA]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    ...
    [SPECIES_VOLTREL]     = { .size = MON_COORDS_SIZE(48, 32), .y_offset = 16 },
    [SPECIES_VOLTREAN]     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    ...
    [SPECIES_RUFFLET]     = { .size = MON_COORDS_SIZE(64, 32), .y_offset = 24 },
    [SPECIES_BRAVIARY]    = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  4 },
    ...
    [SPECIES_MIMIKYU]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  9 },
    ...
    [SPECIES_RAELIC]    = { .size = MON_COORDS_SIZE(40, 32), .y_offset = 16 },
    [SPECIES_ROMUSHU]     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 12 },
    [SPECIES_FUSANG]      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    ...
    [SPECIES_TYNAMO]      = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 16 },
    [SPECIES_EELEKTRIK]      = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    [SPECIES_EELEKTROSS]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_PAWNIARD]      = { .size = MON_COORDS_SIZE(56, 32), .y_offset = 16 },
    ...
    [SPECIES_SOLOSIS]     = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 15 },
    [SPECIES_DUOSION]      = { .size = MON_COORDS_SIZE(32, 48), .y_offset =  9 },
    [SPECIES_REUNICLUS]     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  5 },
    [SPECIES_FLETCHLING]      = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 14 },
    [SPECIES_FLETCHADIN]       = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 12 },
    [SPECIES_TALONFLAME]      = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  8 },
    ...
    [SPECIES_AXEW]     = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 14 },
    [SPECIES_FRAXURE]     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  3 },
    [SPECIES_HAXORUS]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    ...
    [SPECIES_SKORUPI]     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  8 },
    [SPECIES_DRAPION]    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
    ...
    [SPECIES_KROLUCADA]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_KROLUCARD]    = { .size = MON_COORDS_SIZE(40, 48), .y_offset =  8 },
    ...
    [SPECIES_GIBLE]       = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 11 },
    [SPECIES_GABITE]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  9 },
    ...
    [SPECIES_DECIBELLE]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_ARCEUS]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_TINKATINK]                       = { .size = MON_COORDS_SIZE(32, 48), .y_offset =  9 },
    [SPECIES_TINKATUFF]                        = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 14 },
    [SPECIES_TINKATON]                    = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 12 },
    ...
    [SPECIES_SPIRITOMB]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    ...
    [SPECIES_LARVESTA]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_VOLCARONA]                      = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 12 },
    [SPECIES_MISMAGIUS]                    = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  3 },
    [SPECIES_DEINO]                      = { .size = MON_COORDS_SIZE(32, 56), .y_offset =  9 },
    [SPECIES_ZWEILOUS]                     = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    [SPECIES_HYDREIGON]                    = { .size = MON_COORDS_SIZE(40, 56), .y_offset =  6 },
    [SPECIES_PORYGON_Z]                    = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  4 },
    ...
    [SPECIES_SNOVER]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_ABOMASNOW]                     = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  7 },
    [SPECIES_SYLVEON]                      = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  4 },
    [SPECIES_TANGROWTH]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_CORSOREEF]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 10 },
    [SPECIES_WEAVILE]                      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  4 },
    [SPECIES_YANMEGA]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
    [SPECIES_KUJINOUGHT]                   = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  1 },
