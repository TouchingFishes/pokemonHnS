...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_ROSELIA]     = { .size = MON_COORDS_SIZE(56, 32), .y_offset = 16 },
    [SPECIES_ROSERADE]      = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 15 },
    ...
    [SPECIES_PSYCHU]     = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  7 },
