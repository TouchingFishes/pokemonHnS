...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_MORGREM]     = { .size = MON_COORDS_SIZE(48, 56), .y_offset = 11 },
    ...
    [SPECIES_VOLTREL]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 13 },
    [SPECIES_VOLTREAN]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    ...
    [SPECIES_PSYCHU]      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    ...
    [SPECIES_GALLADE]     = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 12 },
    ...
    [SPECIES_LARVICID]      = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 18 },
    [SPECIES_PENDRAGON]      = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    ...
    [SPECIES_KROLUCARD]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    ...
    [SPECIES_DECIBELLE]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    ...
    [SPECIES_CORSOREEF]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_WEAVILE]     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  4 },
    [SPECIES_YANMEGA]     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
    [SPECIES_KUJINOUGHT]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_DUNDRAG]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_DUNLONG]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    ...
    [SPECIES_NOHFACE]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    [SPECIES_KITSUNOH]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  5 },
    ...
    [SPECIES_SPOINK]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 10 },
    ...
    [SPECIES_FLITTLE]      = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 10 },
    [SPECIES_ESPATHRA]    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  3 },
    ...
    [SPECIES_DARMANITAN_TRANCE] = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 14 },
    ...
    [SPECIES_GEMGEIST]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  5 },
    [SPECIES_MAWILE]      = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  8 },
    [SPECIES_BITEMARE]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  5 },
    ...
    [SPECIES_ALT_MEGANIUM]     = { .size = MON_COORDS_SIZE(56, 32), .y_offset = 16 },
    [SPECIES_ALT_TYPHLOSION]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_ALT_FERALIGATR]   = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 14 },
    [SPECIES_RAMNAROK]         = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_RAMNAROK_RADIANT] = { .size = MON_COORDS_SIZE(24, 40), .y_offset = 14 },
};
