...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_BUDEW]     = { .size = MON_COORDS_SIZE(56, 32), .y_offset = 16 },
    [SPECIES_ROSELIA]      = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 15 },
    [SPECIES_ROSERADE]       = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 14 },
    ...
    [SPECIES_EELEKTROSS]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    ...
    [SPECIES_KROLUCARD]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    ...
    [SPECIES_GOTHITA]       = { .size = MON_COORDS_SIZE(24, 40), .y_offset = 15 },
    [SPECIES_GOTHORITA]      = { .size = MON_COORDS_SIZE(32, 56), .y_offset =  6 },
    [SPECIES_GOTHITELLE]   = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  1 },
    ...
    [SPECIES_TURTWIG]    = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  4 },
    [SPECIES_GROTLE]     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  4 },
    [SPECIES_TORTERRA]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_CHIMCHAR]   = { .size = MON_COORDS_SIZE(40, 40), .y_offset =  8 },
    [SPECIES_MONFERNO]   = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  4 },
    [SPECIES_INFERNAPE]  = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  0 },
    [SPECIES_PIPLUP]     = { .size = MON_COORDS_SIZE(32, 32), .y_offset = 12 },
    [SPECIES_PRINPLUP]   = { .size = MON_COORDS_SIZE(40, 40), .y_offset =  8 },
    [SPECIES_EMPOLEON]   = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  0 },
