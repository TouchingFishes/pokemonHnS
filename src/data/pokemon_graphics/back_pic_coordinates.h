...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_VOLTREL]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 14 },
    [SPECIES_VOLTREAN]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
    ...
    [SPECIES_PSYCHU]      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    ...
    [SPECIES_LARVICID]      = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 11 },
    [SPECIES_PENDRAGON]      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    ...
    [SPECIES_KROLUCADA]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    ...
    [SPECIES_SPIRITOMB]  = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    ...
    [SPECIES_KITSUNOH]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
    ...
    [SPECIES_FLITTLE]     = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    [SPECIES_ESPATHRA]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    ...
    [SPECIES_DARMANITAN_TRANCE] = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 11 },
    ...
    [SPECIES_GEMGEIST]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 13 },
    [SPECIES_MAWILE]     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_BITEMARE]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    ...
    [SPECIES_SHELGON]    = { .size = MON_COORDS_SIZE(64, 60), .y_offset = 13 },
    ...
    [SPECIES_ALT_MEGANIUM]     = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 15 },
    [SPECIES_ALT_TYPHLOSION]   = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_ALT_FERALIGATR]   = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 12 },
    [SPECIES_RAMNAROK]         = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  0 },
    [SPECIES_RAMNAROK_RADIANT] = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 13 },
