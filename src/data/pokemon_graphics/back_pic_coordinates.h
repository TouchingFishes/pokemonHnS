...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_ROSELIA]     = { .size = MON_COORDS_SIZE(56, 24), .y_offset = 20 },
    [SPECIES_ROSERADE]      = { .size = MON_COORDS_SIZE(64, 24), .y_offset = 20 },
    ...
    [SPECIES_PSYCHU]     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    ...
    [SPECIES_GEOWATT]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  5 },
