const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(PSYCHU, gMonBackPic_Psychu),
    ...
    SPECIES_SPRITE(RAELIC, gMonBackPic_Raelic),
    SPECIES_SPRITE(ROMUSHU, gMonBackPic_Romushu),
    SPECIES_SPRITE(FUSANG, gMonBackPic_Fusang),
    ...
    SPECIES_SPRITE(FLETCHADIN, gMonBackPic_Fletchadin),
    ...
    SPECIES_SPRITE(LARVICID, gMonBackPic_Larvicid),
    SPECIES_SPRITE(PENDRAGON, gMonBackPic_Pendragon),
    ...
    SPECIES_SPRITE(NOHFACE, gMonBackPic_Nohface),
    ...
    SPECIES_SPRITE(DARMANITAN_TRANCE, gMonBackPic_DarmanitanTrance),
    ...
    SPECIES_SPRITE(ALT_MEGANIUM, gMonBackPic_MeganiumAlt),
    SPECIES_SPRITE(ALT_TYPHLOSION, gMonBackPic_TyphlosionAlt),
    SPECIES_SPRITE(ALT_FERALIGATR, gMonBackPic_FeraligatrAlt),
    SPECIES_SPRITE(RAMNAROK, gMonBackPic_Ramnarok),
    SPECIES_SPRITE(RAMNAROK_RADIANT, gMonBackPic_RamnarokRadiant),
};
