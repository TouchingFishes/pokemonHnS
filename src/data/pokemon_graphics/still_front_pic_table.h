...
// Gen III
    ...
    SPECIES_SPRITE(VOLTREL,       gMonStillFrontPic_Voltrel),
    SPECIES_SPRITE(VOLTREAN,       gMonStillFrontPic_Voltrean),
    ...
    SPECIES_SPRITE(PSYCHU,       gMonStillFrontPic_Psychu),
    ...
    SPECIES_SPRITE(RAELIC,      gMonStillFrontPic_Raelic),
    SPECIES_SPRITE(ROMUSHU,       gMonStillFrontPic_Romushu),
    SPECIES_SPRITE(FUSANG,        gMonStillFrontPic_Fusang),
    ...
    SPECIES_SPRITE(FLETCHADIN,         gMonStillFrontPic_Fletchadin),
    ...
    SPECIES_SPRITE(LARVICID,        gMonStillFrontPic_Larvicid),
    SPECIES_SPRITE(PENDRAGON,        gMonStillFrontPic_Pendragon),
    SPECIES_SPRITE(TROPIUS,       gMonStillFrontPic_Tropius),
    SPECIES_SPRITE(AXEW,       gMonStillFrontPic_Axew),
    SPECIES_SPRITE(FRAXURE,       gMonStillFrontPic_Fraxure),
    SPECIES_SPRITE(HAXORUS,       gMonStillFrontPic_Haxorus),
    ...
    SPECIES_SPRITE(KROLUCADA,       gMonStillFrontPic_Krolucada),
    SPECIES_SPRITE(KROLUCARD,      gMonStillFrontPic_Krolucard),
    ...
    SPECIES_SPRITE(TINKATINK,  gMonStillFrontPic_Tinkatink),
    SPECIES_SPRITE(TINKATUFF,  gMonStillFrontPic_Tinkatuff),
    ...
    SPECIES_SPRITE(CORSOREEF,  gMonStillFrontPic_Corsoreef),
    SPECIES_SPRITE(WEAVILE,  gMonStillFrontPic_Weavile),
    SPECIES_SPRITE(YANMEGA,  gMonStillFrontPic_Yanmega),
    SPECIES_SPRITE(KUJINOUGHT, gMonStillFrontPic_Kujinought),
    SPECIES_SPRITE(DUNDRAG, gMonStillFrontPic_Dundrag),
    SPECIES_SPRITE(DUNLONG, gMonStillFrontPic_Dunlong),
    ...
    SPECIES_SPRITE(FOMANTIS, gMonStillFrontPic_Fomantis),
    SPECIES_SPRITE(LURANTIS, gMonStillFrontPic_Lurantis),
    ...
    SPECIES_SPRITE(GREAVARD, gMonStillFrontPic_Greavard),
    SPECIES_SPRITE(HOUNDSTONE, gMonStillFrontPic_Houndstone),
    SPECIES_SPRITE(KLINK, gMonStillFrontPic_Klink),
    SPECIES_SPRITE(KLANG, gMonStillFrontPic_Klang),
    SPECIES_SPRITE(KLINKLANG, gMonStillFrontPic_Klinklang),
    ...
    SPECIES_SPRITE(FLITTLE, gMonStillFrontPic_Flittle),
    SPECIES_SPRITE(ESPATHRA, gMonStillFrontPic_Espathra),
    SPECIES_SPRITE(SANDILE, gMonStillFrontPic_Sandile),
    SPECIES_SPRITE(KROKOROK, gMonStillFrontPic_Krokorok),
    SPECIES_SPRITE(KROOKODILE, gMonStillFrontPic_Krookodile),
    SPECIES_SPRITE(DARUMAKA, gMonStillFrontPic_Darumaka),
    SPECIES_SPRITE(DARMANITAN, gMonStillFrontPic_Darmanitan),
    SPECIES_SPRITE(DARMANITAN_TRANCE, gMonStillFrontPic_DarmanitanTrance),
    ...
    SPECIES_SPRITE(GEMGEIST, gMonStillFrontPic_Gemgeist),
    SPECIES_SPRITE(MAWILE, gMonStillFrontPic_Mawile),
    SPECIES_SPRITE(BITEMARE, gMonStillFrontPic_Bitemare),
    ...
    SPECIES_SPRITE(ALT_MEGANIUM, gMonStillFrontPic_MeganiumAlt),
    SPECIES_SPRITE(ALT_TYPHLOSION, gMonStillFrontPic_TyphlosionAlt),
    SPECIES_SPRITE(ALT_FERALIGATR, gMonStillFrontPic_FeraligatrAlt),
    SPECIES_SPRITE(RAMNAROK, gMonStillFrontPic_Ramnarok),
    SPECIES_SPRITE(RAMNAROK_RADIANT, gMonStillFrontPic_RamnarokRadiant),
};
