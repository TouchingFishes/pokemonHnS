const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_PSYCHU] = gMonFootprint_Psychu,
    ...
    [SPECIES_RAELIC] = gMonFootprint_Raelic,
    [SPECIES_ROMUSHU] = gMonFootprint_Romushu,
    [SPECIES_FUSANG] = gMonFootprint_Fusang,
    ...
    [SPECIES_FLETCHADIN] = gMonFootprint_Fletchadin,
    ...
    [SPECIES_PURGISLUG] = gMonFootprint_Purgislug,
    [SPECIES_SLAKOTH] = gMonFootprint_Slakoth,
    [SPECIES_VIGOROTH] = gMonFootprint_Vigoroth,
    [SPECIES_SLAKING] = gMonFootprint_Slaking,
    [SPECIES_LARVICID] = gMonFootprint_Larvicid,
    [SPECIES_PENDRAGON] = gMonFootprint_Pendragon,
    ...
    [SPECIES_NOHFACE] = gMonFootprint_Nohface,
    [SPECIES_KITSUNOH] = gMonFootprint_Kitsunoh,
    ...
    [SPECIES_DARMANITAN_TRANCE] = gMonFootprint_DarmanitanTrance,
    ...
    [SPECIES_ALT_MEGANIUM] = gMonFootprint_Meganium,
    [SPECIES_ALT_TYPHLOSION] = gMonFootprint_Typhlosion,
    [SPECIES_ALT_FERALIGATR] = gMonFootprint_Feraligatr,
    [SPECIES_RAMNAROK] = gMonFootprint_Ramnarok,
    [SPECIES_RAMNAROK_RADIANT] = gMonFootprint_Ramnarok,
};
