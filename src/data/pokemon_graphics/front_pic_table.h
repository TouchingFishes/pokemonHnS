const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(PSYCHU, gMonFrontPic_Psychu),
    ...
    SPECIES_SPRITE(RAELIC, gMonFrontPic_Raelic),
    SPECIES_SPRITE(ROMUSHU, gMonFrontPic_Romushu),
    SPECIES_SPRITE(FUSANG, gMonFrontPic_Fusang),
    ...
    SPECIES_SPRITE(FLETCHADIN, gMonFrontPic_Fletchadin),
    ...
    SPECIES_SPRITE(LARVICID, gMonFrontPic_Larvicid),
    SPECIES_SPRITE(PENDRAGON, gMonFrontPic_Pendragon),
    ...
    SPECIES_SPRITE(NOHFACE, gMonFrontPic_Nohface),
    ...
    SPECIES_SPRITE(DARMANITAN_TRANCE, gMonFrontPic_DarmanitanTrance),
    ...
    SPECIES_SPRITE(ALT_MEGANIUM, gMonFrontPic_MeganiumAlt),
    SPECIES_SPRITE(ALT_TYPHLOSION, gMonFrontPic_TyphlosionAlt),
    SPECIES_SPRITE(ALT_FERALIGATR, gMonFrontPic_FeraligatrAlt),
    SPECIES_SPRITE(RAMNAROK, gMonFrontPic_Ramnarok),
    SPECIES_SPRITE(RAMNAROK_RADIANT, gMonFrontPic_RamnarokRadiant),
