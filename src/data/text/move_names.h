const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_SCALD] = _("SCALD"),
    [MOVE_MAGICAL_FIRE] = _("MAGICAL FIRE"),
    ...
    [MOVE_SLUDGE_WAVE] = _("FROST BREATH"),
    [MOVE_MYSTIC_GLEAM] = _("MYSTIC GLEAM"),
    [MOVE_PIXIE_KISS] = _("PIXIE KISS"),
    [MOVE_SPIRIT_BREAK] = _("SPIRIT BREAK"),
    [MOVE_DISARM_CHANT] = _("DISARM CHANT"),
    [MOVE_DOE_EYES] = _("DOE EYES"),
    [MOVE_MOONBLAST] = _("MOONBLAST"),
    [MOVE_FAIRY_WIND] = _("FAIRY WIND"),
    [MOVE_V_CREATE] = _("V CREATE"),
    [MOVE_SPECTRAL_HIT] = _("SPECTRAL HIT"),
