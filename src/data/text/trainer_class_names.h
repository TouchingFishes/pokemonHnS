const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_ELDER] = _("ELDER"),
    [TRAINER_CLASS_SCIENTIST] = _("SCIENTIST"),
    [TRAINER_CLASS_TAMER] = _("TAMER"),
    [TRAINER_CLASS_EX_ELITE] = _("EX ELITE"),
    [TRAINER_CLASS_SKIER] = _("SKIER"),
    [TRAINER_CLASS_GAMBLER] = _("GAMBLER"),
    [TRAINER_CLASS_CASINO_ACE] = _("CASINO ACE"),
    [TRAINER_CLASS_RILEY] = _("{PKMN} TRAINER"),
    [TRAINER_CLASS_BARRY] = _("{PKMN} TRAINER"),
    [TRAINER_CLASS_BUCK] = _("{PKMN} TRAINER"),
    [TRAINER_CLASS_IRIS] = _("UNOVA CHAMP"),
    [TRAINER_CLASS_CYNTHIA] = _("SINNOH CHAMP"),
    [TRAINER_CLASS_STEVEN] = _("HOENN CHAMP"),
    [TRAINER_CLASS_SORA] = _("{PKMN} TRAINER"),
