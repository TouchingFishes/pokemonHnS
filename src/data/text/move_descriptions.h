...
static const u8 sBurningSandDescription[] = _(
...
static const u8 sHammerSmashDescription[] = _(
    "Powerful, but leaves the\n"
    "user immobile the next turn.");
...
static const u8 sDrainLifeDescription[] = _(
    "An attack that absorbs\n"
    "half the damage inflicted.");
...
static const u8 sMagicalFireDescription[] = _(
    "Creates a special, hot\n"
    "fire. Lowers Sp. Atk.");
...
static const u8 sBarrierBashDescription[] = _(
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_BURNING_SAND - 1] = sBurningSandDescription,
    ...
    [MOVE_HAMMER_SMASH - 1] = sHammerSmashDescription,
    [MOVE_TWIN_BEAM - 1] = sTwinBeamDescription,
    [MOVE_DRAIN_LIFE - 1] = sDrainLifeDescription,
    ...
    [MOVE_DRILL_RUN] = sDrillRunDescription,
    ...
    [MOVE_NASTY_PLOT - 1] = sTwinBeamDescription,
    [MOVE_ICE_FANG - 1] = sTwinBeamDescription,
    [MOVE_FIRE_FANG - 1] = sTwinBeamDescription,
    [MOVE_THUNDER_FANG - 1] = sTwinBeamDescription,
    [MOVE_AQUA_TAIL - 1] = sDrainLifeDescription,
    [MOVE_METEOR_BEAM - 1] = sOminousWindDescription,
    ...
    [MOVE_FOUL_PLAY] = sDrillRunDescription,
    [MOVE_POLTERGEIST - 1] = sSteamrollerDescription,
    [MOVE_HEX - 1] = sScaldDescription,
    [MOVE_SLUDGE_WAVE - 1] = sMagicalFireDescription,
    [MOVE_MYSTIC_GLEAM - 1] = sWildChargeDescription,
    [MOVE_PIXIE_KISS - 1] = sBarrierBashDescription,
    [MOVE_SPIRIT_BREAK - 1] = sAcrobaticsDescription,
    [MOVE_DISARM_CHANT - 1] = sHeavySlamDescription,
    [MOVE_DOE_EYES - 1] = sFlameChargeDescription,
