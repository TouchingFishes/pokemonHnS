...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_ROSELIA]    = BACK_ANIM_H_SHAKE,
    [SPECIES_ROSERADE]     = BACK_ANIM_TRIANGLE_DOWN,
    ...
    [SPECIES_PSYCHU]    = BACK_ANIM_H_VIBRATE,
    ...
    [SPECIES_GEOWATT]       = BACK_ANIM_SHRINK_GROW_VIBRATE,
