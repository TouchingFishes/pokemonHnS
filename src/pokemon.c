...
const u16 gEvolutionLines[NUM_SPECIES][EVOS_PER_LINE] =
{
    ...
    [SPECIES_ROSELIA]                           = {SPECIES_TINKATUFF, SPECIES_ROSELIA, SPECIES_ABOMASNOW},
    [SPECIES_TINKATUFF ... SPECIES_ABOMASNOW]        = {SPECIES_TINKATUFF, SPECIES_ROSELIA, SPECIES_ABOMASNOW},
    [SPECIES_ABOMASNOW]                          = {SPECIES_TINKATUFF, SPECIES_ROSELIA, SPECIES_ABOMASNOW},
