...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_FOMANTIS - 1]    = ANIM_TIP_MOVE_FORWARD,
    ...
    [SPECIES_MIMIKYU - 1]     = ANIM_SWING_CONCAVE_FAST_SHORT,
...
static const u8 gSpeciesMapping[NUM_SPECIES+1] =
{
    ...
    [SPECIES_GREAVARD - 1]       = EVO_TYPE_0,
    [SPECIES_HOUNDSTONE - 1]      = EVO_TYPE_1,
...
const u16 gEvolutionLines[NUM_SPECIES][EVOS_PER_LINE] =
{
    ...
    [SPECIES_DUNSPARCE]                         = {SPECIES_DUNSPARCE, SPECIES_MIMIKYU, SPECIES_DUNDRAG, SPECIES_DUNLONG},
    [SPECIES_MIMIKYU]                       = {SPECIES_DUNSPARCE, SPECIES_MIMIKYU, SPECIES_DUNDRAG, SPECIES_DUNLONG},
    [SPECIES_DUNLONG]                           = {SPECIES_DUNSPARCE, SPECIES_MIMIKYU, SPECIES_DUNDRAG, SPECIES_DUNLONG},
    [SPECIES_DUNDRAG]                           = {SPECIES_DUNSPARCE, SPECIES_MIMIKYU, SPECIES_DUNDRAG, SPECIES_DUNLONG},
