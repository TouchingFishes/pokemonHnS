...
static const u8 gSpeciesMapping[NUM_SPECIES+1] =
{
    ...
    [SPECIES_HONEDGE - 1]       = EVO_TYPE_0,
    [SPECIES_DOUBLADE - 1]      = EVO_TYPE_1,
    [SPECIES_AEGISLASH - 1]     = EVO_TYPE_2,
    ...
    [SPECIES_BUIZEL - 1]        = EVO_TYPE_0,
    [SPECIES_FLOATZEL - 1]      = EVO_TYPE_1,
...
const u16 gEvolutionLines[NUM_SPECIES][EVOS_PER_LINE] =
{
    ...
    [SPECIES_ROSELIA ... SPECIES_LOTAD]        = {SPECIES_ROSELIA, SPECIES_ROSERADE, SPECIES_LOTAD},
    [SPECIES_LOMBRE ... SPECIES_LUDICOLO]        = {SPECIES_LOMBRE, SPECIES_LUDICOLO},
