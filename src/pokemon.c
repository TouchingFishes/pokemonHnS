...
const u16 gEvolutionLines[NUM_SPECIES][EVOS_PER_LINE] =
{
    ...
    [SPECIES_ROSELIA]                           = {SPECIES_TINKATUFF, SPECIES_ROSELIA, SPECIES_ROSERADE},
    [SPECIES_TINKATUFF ... SPECIES_ROSERADE]        = {SPECIES_TINKATUFF, SPECIES_ROSELIA, SPECIES_ROSERADE},
    [SPECIES_ROSERADE]                          = {SPECIES_TINKATUFF, SPECIES_ROSELIA, SPECIES_ROSERADE},
