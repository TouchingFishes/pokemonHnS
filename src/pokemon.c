...
const u16 gEvolutionLines[NUM_SPECIES][EVOS_PER_LINE] =
{
    ...
    [SPECIES_DUNSPARCE]                         = {SPECIES_DUNSPARCE, SPECIES_DUNDRAG, SPECIES_DUNLONG},
    [SPECIES_DUNLONG]                           = {SPECIES_DUNSPARCE, SPECIES_DUNDRAG, SPECIES_DUNLONG},
    [SPECIES_DUNDRAG]                           = {SPECIES_DUNSPARCE, SPECIES_DUNDRAG, SPECIES_DUNLONG},
