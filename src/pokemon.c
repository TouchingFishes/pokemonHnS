...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(LOTUGA),
    SPECIES_TO_HOENN(VERTUGA),
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(LOTUGA),
    SPECIES_TO_NATIONAL(VERTUGA),
...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
    ...
    HOENN_TO_NATIONAL(LOTUGA),
    HOENN_TO_NATIONAL(VERTUGA),
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_FLABEBE - 1]     = ANIM_V_SLIDE,
    [SPECIES_FLOETTE - 1]      = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_FLORGES - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LOTUGA - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_VERTUGA - 1]    = ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW,
    ...
    [SPECIES_RUFFLET - 1]     = ANIM_H_PIVOT,
    [SPECIES_BRAVIARY - 1]    = ANIM_V_SLIDE_WOBBLE,
    ...
    [SPECIES_MIMIKYU - 1]     = ANIM_GLOW_BLACK,
    ...
    [SPECIES_TYNAMO - 1]      = ANIM_SPIN,
    [SPECIES_EELEKTRIK - 1]      = ANIM_V_STRETCH,
    [SPECIES_EELEKTROSS - 1]     = ANIM_H_SHAKE,
    [SPECIES_PAWNIARD - 1]      = ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW,
    [SPECIES_BISHARP - 1]    = ANIM_V_SLIDE,
    ...
    [SPECIES_DUOSION - 1]      = ANIM_H_JUMPS_V_STRETCH_TWICE,
    [SPECIES_REUNICLUS - 1]     = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_FLETCHLING - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_FLETCHADIN - 1]       = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_TALONFLAME - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_AXEW - 1]     = ANIM_H_SLIDE,
    [SPECIES_FRAXURE - 1]     = ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW,
    ...
    [SPECIES_SKORUPI - 1]     = ANIM_V_STRETCH,
    [SPECIES_DRAPION - 1]    = ANIM_GROW_VIBRATE,
    ...
    [SPECIES_GIBLE - 1]       = ANIM_V_SHAKE_TWICE,
    [SPECIES_GABITE - 1]     = ANIM_V_SLIDE,
    ...
    [SPECIES_SPIRITOMB - 1]      = ANIM_H_SLIDE,
    ...
    [SPECIES_LARVESTA - 1]     = ANIM_BACK_AND_LUNGE,
    [SPECIES_VOLCARONA - 1]       = ANIM_TWIST_TWICE,
    [SPECIES_MISMAGIUS - 1]     = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_DEINO - 1]       = ANIM_H_SLIDE_SLOW,
    [SPECIES_ZWEILOUS - 1]      = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_HYDREIGON - 1]     = ANIM_CIRCLE_C_CLOCKWISE_SLOW,
    [SPECIES_PORYGON_Z - 1]     = ANIM_V_SLIDE,
    [SPECIES_REGIDRAGO - 1]     = ANIM_GLOW_RED,
    [SPECIES_REGIELEKI - 1]   = ANIM_SHAKE_FLASH_YELLOW_SLOW,
    [SPECIES_REGIGIGAS - 1]     = ANIM_V_SHAKE,
    [SPECIES_SNOVER - 1]     = ANIM_V_SHAKE_TWICE,
    [SPECIES_ABOMASNOW - 1]      = ANIM_H_VIBRATE,
    ...
    [SPECIES_HONEDGE - 1] = ANIM_V_SHAKE,
    [SPECIES_DOUBLADE - 1] = ANIM_V_SHAKE,
...
static const u8 gSpeciesMapping[NUM_SPECIES+1] =
{
    ...
    [SPECIES_FLABEBE]           = EVO_TYPE_1,
    [SPECIES_FLOETTE]            = EVO_TYPE_2,
    [SPECIES_FLORGES]             = EVO_TYPE_0,
    [SPECIES_LOTUGA]            = EVO_TYPE_1,
    [SPECIES_VERTUGA]          = EVO_TYPE_2,
    ...
    [SPECIES_DUOSION]            = EVO_TYPE_0,
    [SPECIES_REUNICLUS]           = EVO_TYPE_1,
    ...
    [SPECIES_TINKATUFF]             = EVO_TYPE_0,
    [SPECIES_TINKATON]         = EVO_TYPE_0,
    [SPECIES_SPIRITOMB]          = EVO_TYPE_2,
...
const u16 gEvolutionLines[NUM_SPECIES][EVOS_PER_LINE] =
{
    ...
    [SPECIES_MANKEY ... SPECIES_PRIMEAPE]     = {SPECIES_MANKEY, SPECIES_PRIMEAPE, SPECIES_KUJINOUGHT},
    [SPECIES_KUJINOUGHT]                      = {SPECIES_MANKEY, SPECIES_PRIMEAPE, SPECIES_KUJINOUGHT},
    ...
    [SPECIES_LICKITUNG]                         = {SPECIES_LICKITUNG, SPECIES_GEKOPON},
    [SPECIES_GEKOPON]                        = {SPECIES_LICKITUNG, SPECIES_GEKOPON},
    [SPECIES_KOFFING ... SPECIES_WEEZING]       = {SPECIES_KOFFING, SPECIES_WEEZING},
    [SPECIES_RHYHORN ... SPECIES_RHYDON]        = {SPECIES_RHYHORN, SPECIES_RHYDON, SPECIES_SNOVER},
    [SPECIES_SNOVER]                         = {SPECIES_RHYHORN, SPECIES_RHYDON, SPECIES_SNOVER},
    ...
    [SPECIES_MR_MIME]                           = {SPECIES_DEINO, SPECIES_MR_MIME},
    [SPECIES_DEINO]                           = {SPECIES_DEINO, SPECIES_MR_MIME},
    ...
    [SPECIES_PORYGON]                           = {SPECIES_PORYGON, SPECIES_PORYGON2, SPECIES_HYDREIGON},
    [SPECIES_PORYGON2]                          = {SPECIES_PORYGON, SPECIES_PORYGON2, SPECIES_HYDREIGON},
    [SPECIES_HYDREIGON]                         = {SPECIES_PORYGON, SPECIES_PORYGON2, SPECIES_HYDREIGON},
    ...
    [SPECIES_SNORLAX]                           = {SPECIES_ZWEILOUS, SPECIES_SNORLAX},
    [SPECIES_ZWEILOUS]                          = {SPECIES_ZWEILOUS, SPECIES_SNORLAX},
    ...
    [SPECIES_TOGEPI ... SPECIES_TOGETIC]        = {SPECIES_TOGEPI, SPECIES_TOGETIC, SPECIES_CORSOREEF},
    [SPECIES_CORSOREEF]                          = {SPECIES_TOGEPI, SPECIES_TOGETIC, SPECIES_CORSOREEF},
    ...
    [SPECIES_MARILL ... SPECIES_AZUMARILL]      = {SPECIES_SOLOSIS, SPECIES_MARILL, SPECIES_AZUMARILL},
    [SPECIES_SOLOSIS]                           = {SPECIES_SOLOSIS, SPECIES_MARILL, SPECIES_AZUMARILL},
    [SPECIES_SUDOWOODO]                         = {SPECIES_TINKATINK, SPECIES_SUDOWOODO},
    [SPECIES_TINKATINK]                            = {SPECIES_TINKATINK, SPECIES_SUDOWOODO},
    [SPECIES_HOPPIP ... SPECIES_JUMPLUFF]       = {SPECIES_HOPPIP, SPECIES_SKIPLOOM, SPECIES_JUMPLUFF},
    [SPECIES_AIPOM]                             = {SPECIES_AIPOM, SPECIES_DECIBELLE},
    [SPECIES_DECIBELLE]                           = {SPECIES_AIPOM, SPECIES_DECIBELLE},
    ...
    [SPECIES_WOBBUFFET]                         = {SPECIES_MLLOY, SPECIES_WOBBUFFET},
    [SPECIES_MLLOY]                            = {SPECIES_MLLOY, SPECIES_WOBBUFFET},
    ...
    [SPECIES_SWINUB ... SPECIES_PILOSWINE]      = {SPECIES_SWINUB, SPECIES_PILOSWINE, SPECIES_LARVESTA},
    [SPECIES_LARVESTA]                         = {SPECIES_SWINUB, SPECIES_PILOSWINE, SPECIES_LARVESTA},
    [SPECIES_REMORAID ... SPECIES_OCTILLERY]    = {SPECIES_REMORAID, SPECIES_OCTILLERY},
    [SPECIES_MANTINE]                           = {SPECIES_VOLCARONA, SPECIES_MANTINE},
    [SPECIES_VOLCARONA]                           = {SPECIES_VOLCARONA, SPECIES_MANTINE},
    ...
    [SPECIES_IMPIDIMP ... SPECIES_FLOETTE]        = {SPECIES_IMPIDIMP, SPECIES_MORGREM, SPECIES_GRIMMSNARL, SPECIES_FLABEBE, SPECIES_FLOETTE},
    [SPECIES_FLORGES ... SPECIES_VERTUGA]        = {SPECIES_FLORGES, SPECIES_LOTUGA, SPECIES_VERTUGA},
    ...
    [SPECIES_NOSEPASS]                          = {SPECIES_NOSEPASS, SPECIES_PORYGON_Z},
    [SPECIES_PORYGON_Z]                         = {SPECIES_NOSEPASS, SPECIES_PORYGON_Z},
    ...
    [SPECIES_DUOSION ... SPECIES_REUNICLUS]        = {SPECIES_DUOSION, SPECIES_REUNICLUS},
    ...
    [SPECIES_DUSKULL ... SPECIES_DUSCLOPS]      = {SPECIES_DUSKULL, SPECIES_DUSCLOPS, SPECIES_SPIRITOMB},
    [SPECIES_SPIRITOMB]                          = {SPECIES_DUSKULL, SPECIES_DUSCLOPS, SPECIES_SPIRITOMB},
    [SPECIES_SLAKOTH ... SPECIES_SLAKING]       = {SPECIES_SLAKOTH, SPECIES_VIGOROTH, SPECIES_SLAKING},
    [SPECIES_PURGISLUG]                           = {SPECIES_TINKATUFF, SPECIES_PURGISLUG, SPECIES_ABOMASNOW},
    [SPECIES_TINKATUFF ... SPECIES_ABOMASNOW]        = {SPECIES_TINKATUFF, SPECIES_PURGISLUG, SPECIES_ABOMASNOW},
    [SPECIES_ABOMASNOW]                          = {SPECIES_TINKATUFF, SPECIES_PURGISLUG, SPECIES_ABOMASNOW},
    ...
    [SPECIES_CHIMECHO]                          = {SPECIES_TINKATON, SPECIES_CHIMECHO},
    [SPECIES_TINKATON]                         = {SPECIES_TINKATON, SPECIES_CHIMECHO},
    [SPECIES_DUNSPARCE]                         = {SPECIES_DUNSPARCE, SPECIES_DUNLONG},
    [SPECIES_DUNLONG]                       = {SPECIES_DUNSPARCE, SPECIES_DUNLONG},
    [SPECIES_GIRAFARIG]                         = {SPECIES_GIRAFARIG, SPECIES_DUNDRAG},
    [SPECIES_DUNDRAG]                         = {SPECIES_GIRAFARIG, SPECIES_DUNDRAG},
};
