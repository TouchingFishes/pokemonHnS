...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_PSYCHU] = gMonIcon_Psychu,
    ...
    [SPECIES_RAELIC] = gMonIcon_Raelic,
    [SPECIES_ROMUSHU] = gMonIcon_Romushu,
    [SPECIES_FUSANG] = gMonIcon_Fusang,
    ...
    [SPECIES_FLETCHADIN] = gMonIcon_Fletchadin,
    ...
    [SPECIES_PURGISLUG] = gMonIcon_Purgislug,
    [SPECIES_SLAKOTH] = gMonIcon_Slakoth,
    [SPECIES_VIGOROTH] = gMonIcon_Vigoroth,
    [SPECIES_SLAKING] = gMonIcon_Slaking,
    [SPECIES_LARVICID] = gMonIcon_Larvicid,
    [SPECIES_PENDRAGON] = gMonIcon_Pendragon,
    ...
    [SPECIES_NOHFACE] = gMonIcon_Nohface,
    ...
    [SPECIES_DARMANITAN_TRANCE] = gMonIcon_DarmanitanTrance,
    ...
    [SPECIES_ALT_MEGANIUM] = gMonIcon_Meganium,
    [SPECIES_ALT_TYPHLOSION] = gMonIcon_Typhlosion,
    [SPECIES_ALT_FERALIGATR] = gMonIcon_Feraligatr,
    [SPECIES_RAMNAROK] = gMonIcon_Ramnarok,
    [SPECIES_RAMNAROK_RADIANT] = gMonIcon_RamnarokRadiant,
};
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_PRINPLUP] = 0,
    [SPECIES_EMPOLEON] = 0,
    [SPECIES_ALT_MEGANIUM] = 0,
    [SPECIES_ALT_TYPHLOSION] = 0,
    [SPECIES_ALT_FERALIGATR] = 0,
    [SPECIES_RAMNAROK] = 0,
    [SPECIES_RAMNAROK_RADIANT] = 0,
};
