...
const struct SpriteFrameImage gTrainerBackPicTable_Silver[] =
{
    {gTrainerBackPic_Silver + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Silver + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Silver + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Silver + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};
