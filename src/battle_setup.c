...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_GRUNT_33, TRAINER_AMBER, TRAINER_CORY, TRAINER_MOTO, TRAINER_ROSE_5, ROUTE118),
    ...
    [REMATCH_WILTON] = REMATCH(TRAINER_DILLON, TRAINER_EVAN, TRAINER_OSCAR, TRAINER_AUBREE, TRAINER_WILTON_5, ROUTE111),
