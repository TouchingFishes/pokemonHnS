...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_KOJI] = REMATCH(TRAINER_KOJI, TRAINER_KOJI_2, TRAINER_KOJI_3, TRAINER_NONE, TRAINER_NONE, ROUTE127),
    ...
    [REMATCH_EDWIN] = REMATCH(TRAINER_EDWIN, TRAINER_EDWIN_2, TRAINER_EDWIN_3, TRAINER_NONE, TRAINER_NONE, ROUTE110),
