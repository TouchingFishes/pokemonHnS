...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_ROSE, TRAINER_ROSE_2, TRAINER_ROSE_3, TRAINER_NONE, TRAINER_NONE, ROUTE118),
    [REMATCH_JOEY] = REMATCH(TRAINER_JOEY, TRAINER_JOEY_2, TRAINER_JOEY_3, TRAINER_NONE, TRAINER_NONE, ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_DUSTY, TRAINER_DUSTY_2, TRAINER_DUSTY_3, TRAINER_NONE, TRAINER_NONE, ROUTE111),
    [REMATCH_WADE] = REMATCH(TRAINER_WADE, TRAINER_WADE_2, TRAINER_WADE_3, TRAINER_NONE, TRAINER_NONE, ROUTE109),
    [REMATCH_BETH] = REMATCH(TRAINER_BETH, TRAINER_BETH_2, TRAINER_BETH_3, TRAINER_NONE, TRAINER_NONE, ROUTE109),
    [REMATCH_LILA_AND_ROY] = REMATCH(TRAINER_LILA_AND_ROY_1, TRAINER_LILA_AND_ROY_2, TRAINER_LILA_AND_ROY_3, TRAINER_NONE, TRAINER_NONE, ROUTE124),
    [REMATCH_TAMMY] = REMATCH(TRAINER_TAMMY, TRAINER_TAMMY_2, TRAINER_TAMMY_3, TRAINER_NONE, TRAINER_NONE, ROUTE121),
    [REMATCH_LIZ] = REMATCH(TRAINER_LIZ, TRAINER_LIZ_2, TRAINER_LIZ_3, TRAINER_NONE, TRAINER_NONE, ROUTE111),
    [REMATCH_WILTON] = REMATCH(TRAINER_WILTON, TRAINER_WILTON_2, TRAINER_WILTON_3, TRAINER_NONE, TRAINER_NONE, ROUTE111),
    [REMATCH_VALERIE] = REMATCH(TRAINER_VALERIE_1, TRAINER_VALERIE_2, TRAINER_VALERIE_3, TRAINER_NONE, TRAINER_NONE, MT_PYRE_6F),
    [REMATCH_RALPH] = REMATCH(TRAINER_RALPH, TRAINER_RALPH_2, TRAINER_RALPH_3, TRAINER_NONE, TRAINER_NONE, ROUTE104),
    [REMATCH_THALIA] = REMATCH(TRAINER_THALIA_1, TRAINER_THALIA_2, TRAINER_THALIA_3, TRAINER_NONE, TRAINER_NONE, ABANDONED_SHIP_ROOMS_1F),
    [REMATCH_JESSICA] = REMATCH(TRAINER_ARIANA_1, TRAINER_ARIANA_2, TRAINER_MARIK, TRAINER_NONE, TRAINER_NONE, ROUTE121),
    [REMATCH_WINSTON] = REMATCH(TRAINER_WINSTON_1, TRAINER_WINSTON_2, TRAINER_WINSTON_3, TRAINER_NONE, TRAINER_NONE, ROUTE104),
    [REMATCH_ANTHONY] = REMATCH(TRAINER_ANTHONY, TRAINER_ANTHONY_2, TRAINER_ANTHONY_3, TRAINER_NONE, TRAINER_NONE, ROUTE114),
    [REMATCH_TONY] = REMATCH(TRAINER_TONY_1, TRAINER_TONY_2, TRAINER_TONY_3, TRAINER_NONE, TRAINER_NONE, ROUTE107),
    [REMATCH_GINA] = REMATCH(TRAINER_GINA, TRAINER_GINA_2, TRAINER_GINA_3, TRAINER_NONE, TRAINER_NONE, ROUTE115),
    [REMATCH_KOJI] = REMATCH(TRAINER_KOJI_1, TRAINER_KOJI_2, TRAINER_KOJI_3, TRAINER_NONE, TRAINER_NONE, ROUTE127),
    [REMATCH_TODD] = REMATCH(TRAINER_TODD, TRAINER_TODD_2, TRAINER_TODD_3, TRAINER_NONE, TRAINER_NONE, ROUTE123),
    [REMATCH_ARNIE] = REMATCH(TRAINER_ARNIE, TRAINER_ARNIE_2, TRAINER_ARNIE_3, TRAINER_NONE, TRAINER_NONE, ROUTE118),
    [REMATCH_JACK] = REMATCH(TRAINER_JACK, TRAINER_JACK_2, TRAINER_JACK_3, TRAINER_NONE, TRAINER_NONE, ROUTE114),
    [REMATCH_ALAN] = REMATCH(TRAINER_ALAN, TRAINER_ALAN_2, TRAINER_ALAN_3, TRAINER_NONE, TRAINER_NONE, JAGGED_PASS),
    [REMATCH_JOHN_AND_JAY] = REMATCH(TRAINER_JOHN_AND_JAY_1, TRAINER_JOHN_AND_JAY_2, TRAINER_JOHN_AND_JAY_3, TRAINER_NONE, TRAINER_NONE, METEOR_FALLS_1F_2R),
    [REMATCH_DANA] = REMATCH(TRAINER_DANA, TRAINER_DANA_2, TRAINER_DANA_3, TRAINER_NONE, TRAINER_NONE, ROUTE120),
    [REMATCH_CAMERON] = REMATCH(TRAINER_GAVEN, TRAINER_GINA, TRAINER_GLENN, TRAINER_NONE, TRAINER_NONE, ROUTE123),
    [REMATCH_CHAD] = REMATCH(TRAINER_CHAD, TRAINER_CHAD_2, TRAINER_CHAD_3, TRAINER_NONE, TRAINER_NONE, ROUTE123),
    [REMATCH_WALTER] = REMATCH(TRAINER_WALTER_1, TRAINER_WALTER_2, TRAINER_WALTER_3, TRAINER_NONE, TRAINER_NONE, ROUTE121),
    [REMATCH_HUEY] = REMATCH(TRAINER_HUEY, TRAINER_HUEY_2, TRAINER_HUEY_3, TRAINER_NONE, TRAINER_NONE, ROUTE116),
    [REMATCH_TULLY] = REMATCH(TRAINER_TULLY, TRAINER_TULLY_2, TRAINER_TULLY_3, TRAINER_NONE, TRAINER_NONE, ROUTE116),
    [REMATCH_ANNA_AND_MEG] = REMATCH(TRAINER_ANNA_AND_MEG_1, TRAINER_ANNA_AND_MEG_2, TRAINER_ANNA_AND_MEG_3, TRAINER_NONE, TRAINER_NONE, ROUTE117),
    [REMATCH_ISABEL] = REMATCH(TRAINER_LTSURGE, TRAINER_ERIKA, TRAINER_SABRINA, TRAINER_NONE, TRAINER_NONE, ROUTE110),
    [REMATCH_MIGUEL] = REMATCH(TRAINER_MIGUEL_1, TRAINER_MIGUEL_2, TRAINER_MIGUEL_3, TRAINER_NONE, TRAINER_NONE, ROUTE103),
    [REMATCH_TIMOTHY] = REMATCH(TRAINER_TIMOTHY_1, TRAINER_TIMOTHY_2, TRAINER_TIMOTHY_3, TRAINER_NONE, TRAINER_NONE, ROUTE115),
    [REMATCH_SHELBY] = REMATCH(TRAINER_SHELBY_1, TRAINER_SHELBY_2, TRAINER_SHELBY_3, TRAINER_NONE, TRAINER_NONE, MT_CHIMNEY),
    [REMATCH_CALVIN] = REMATCH(TRAINER_EUGENE, TRAINER_FIDEL, TRAINER_FRAN, TRAINER_NONE, TRAINER_NONE, ROUTE102),
    [REMATCH_ELLIOT] = REMATCH(TRAINER_MASA, TRAINER_MATHEW, TRAINER_MEG_AND_PEG, TRAINER_NONE, TRAINER_NONE, ROUTE106),
    [REMATCH_TIFFANY] = REMATCH(TRAINER_TIFFANY, TRAINER_TIFFANY_2, TRAINER_TIFFANY_3, TRAINER_NONE, TRAINER_NONE, ROUTE128),
    [REMATCH_MARIA] = REMATCH(TRAINER_MARIA_1, TRAINER_MARIA_2, TRAINER_MARIA_3, TRAINER_NONE, TRAINER_NONE, ROUTE117),
    [REMATCH_ABIGAIL] = REMATCH(TRAINER_ABE, TRAINER_AL, TRAINER_ALFRED, TRAINER_NONE, TRAINER_NONE, ROUTE110),
    [REMATCH_BRENT] = REMATCH(TRAINER_BRENT, TRAINER_BRENT_2, TRAINER_BRENT_3, TRAINER_NONE, TRAINER_NONE, ROUTE117),
    [REMATCH_KATELYN] = REMATCH(TRAINER_KATELYN_1, TRAINER_KATELYN_2, TRAINER_KATELYN_3, TRAINER_NONE, TRAINER_NONE, ROUTE128),
    [REMATCH_BENJAMIN] = REMATCH(TRAINER_BENJAMIN, TRAINER_BENJAMIN_2, TRAINER_BENJAMIN_3, TRAINER_NONE, TRAINER_NONE, ROUTE110),
    [REMATCH_PAOLO] = REMATCH(TRAINER_PAOLO_1, TRAINER_PAOLO_2, TRAINER_PAOLO_3, TRAINER_NONE, TRAINER_NONE, ROUTE126),
    [REMATCH_NICOLAS] = REMATCH(TRAINER_NICOLAS_1, TRAINER_NICOLAS_2, TRAINER_NICOLAS_3, TRAINER_NONE, TRAINER_NONE, METEOR_FALLS_1F_2R),
    [REMATCH_ROBERT] = REMATCH(TRAINER_ROBERT_1, TRAINER_ROBERT_2, TRAINER_ROBERT_3, TRAINER_NONE, TRAINER_NONE, ROUTE120),
    [REMATCH_VANCE] = REMATCH(TRAINER_VANCE, TRAINER_VANCE_2, TRAINER_VANCE_3, TRAINER_NONE, TRAINER_NONE, ROUTE113),
    [REMATCH_PARRY] = REMATCH(TRAINER_PARRY, TRAINER_PARRY_2, TRAINER_PARRY_3, TRAINER_NONE, TRAINER_NONE, ROUTE115),
    [REMATCH_MADELINE] = REMATCH(TRAINER_MADELINE_1, TRAINER_MADELINE_2, TRAINER_MADELINE_3, TRAINER_NONE, TRAINER_NONE, ROUTE113),
    [REMATCH_ERIN] = REMATCH(TRAINER_ERIN, TRAINER_ERIN_2, TRAINER_ERIN_3, TRAINER_NONE, TRAINER_NONE, ROUTE124),
    [REMATCH_JOSE] = REMATCH(TRAINER_JOSE, TRAINER_JOSE_2, TRAINER_JOSE_3, TRAINER_NONE, TRAINER_NONE, JAGGED_PASS),
    [REMATCH_AMY_AND_LIV] = REMATCH(TRAINER_AMY_AND_MAY, TRAINER_ANN_AND_ANNE, TRAINER_AMY_AND_LIV_4, TRAINER_NONE, TRAINER_NONE, ROUTE103),
    [REMATCH_REENA] = REMATCH(TRAINER_REENA, TRAINER_REENA_2, TRAINER_REENA_3, TRAINER_NONE, TRAINER_NONE, ROUTE125),
    [REMATCH_CORY] = REMATCH(TRAINER_GRUNT_29, TRAINER_HAL, TRAINER_HANK, TRAINER_NONE, TRAINER_NONE, ROUTE108),
    [REMATCH_GAVEN] = REMATCH(TRAINER_GAVEN, TRAINER_GAVEN_2, TRAINER_GAVEN_3, TRAINER_NONE, TRAINER_NONE, ROUTE110),
    [REMATCH_LYDIA] = REMATCH(TRAINER_LYDIA_1, TRAINER_LYDIA_2, TRAINER_LYDIA_3, TRAINER_NONE, TRAINER_NONE, ROUTE117),
    [REMATCH_SU] = REMATCH(TRAINER_SU, TRAINER_SU_2, TRAINER_SU_3, TRAINER_NONE, TRAINER_NONE, ROUTE117),
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_ROD, TRAINER_RON, TRAINER_ROSS, TRAINER_NONE, TRAINER_NONE, MT_PYRE_3F),
    [REMATCH_CATHERINE] = REMATCH(TRAINER_GRUNT_3, TRAINER_GRUNT_4, TRAINER_GRUNT_5, TRAINER_NONE, TRAINER_NONE, ROUTE119),
    [REMATCH_MARK] = REMATCH(TRAINER_MARK, TRAINER_MARK_2, TRAINER_MARK_3, TRAINER_NONE, TRAINER_NONE, ROUTE119),
    [REMATCH_AMALA] = REMATCH(TRAINER_AMALA, TRAINER_AMALA_2, TRAINER_AMALA_3, TRAINER_NONE, TRAINER_NONE, ROUTE104),
    [REMATCH_DEREK] = REMATCH(TRAINER_DEREK, TRAINER_DEREK_2, TRAINER_DEREK_3, TRAINER_NONE, TRAINER_NONE, PETALBURG_WOODS),
    [REMATCH_MAGNOLIA] = REMATCH(TRAINER_MAGNOLIA, TRAINER_MAGNOLIA_2, TRAINER_MAGNOLIA_3, TRAINER_NONE, TRAINER_NONE, ROUTE112),
    [REMATCH_ZANDER] = REMATCH(TRAINER_ZANDER, TRAINER_ZANDER_2, TRAINER_ZANDER_3, TRAINER_NONE, TRAINER_NONE, MT_CHIMNEY),
    [REMATCH_KIRA_AND_DAN] = REMATCH(TRAINER_KIRA_AND_DAN_1, TRAINER_KIRA_AND_DAN_2, TRAINER_KIRA_AND_DAN_3, TRAINER_NONE, TRAINER_NONE, ABANDONED_SHIP_ROOMS2_1F),
    [REMATCH_WALLY_VR] = REMATCH(TRAINER_WALLY_VR_2, TRAINER_WALLY_VR_3, TRAINER_WALLY_VR_4, TRAINER_NONE, TRAINER_NONE, VICTORY_ROAD_1F),
    [REMATCH_ROXANNE] = REMATCH(TRAINER_ROXANNE_1, TRAINER_ROXANNE_2, TRAINER_ROXANNE_3, TRAINER_NONE, TRAINER_NONE, RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_DICK, TRAINER_DIRK, TRAINER_DON, TRAINER_NONE, TRAINER_NONE, DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(TRAINER_WATTSON_1, TRAINER_WATTSON_4, TRAINER_WATTSON_4, TRAINER_NONE, TRAINER_NONE, MAUVILLE_CITY),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_PING, TRAINER_QUENTIN, TRAINER_QUINN, TRAINER_NONE, TRAINER_NONE, LAVARIDGE_TOWN),
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN_1, TRAINER_NORMAN_2, TRAINER_NORMAN_3, TRAINER_NONE, TRAINER_NONE, PETALBURG_CITY),
    [REMATCH_WINONA] = REMATCH(TRAINER_WINONA_1, TRAINER_WINONA_2, TRAINER_WINONA_3, TRAINER_NONE, TRAINER_NONE, FORTREE_CITY),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_TATE_AND_LIZA_1, TRAINER_TATE_AND_LIZA_2, TRAINER_TATE_AND_LIZA_3, TRAINER_NONE, TRAINER_NONE, MOSSDEEP_CITY),
    [REMATCH_JUAN] = REMATCH(TRAINER_JUAN_1, TRAINER_JUAN_2, TRAINER_JUAN_3, TRAINER_NONE, TRAINER_NONE, SOOTOPOLIS_CITY),
    [REMATCH_SIDNEY] = REMATCH(TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_NONE, TRAINER_NONE, EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_NONE, TRAINER_NONE, EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_NONE, TRAINER_NONE, EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_KIP, TRAINER_KIP, TRAINER_KIP, TRAINER_NONE, TRAINER_NONE, EVER_GRANDE_CITY),
    [REMATCH_WALLACE] = REMATCH(TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_NONE, TRAINER_NONE, EVER_GRANDE_CITY),
};
...
#define FINAL_REMATCH_TIER_INDEX            2
#define FINAL_REMATCH_TIER_BADGE_REQUIRED   9
