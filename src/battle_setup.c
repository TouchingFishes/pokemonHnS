...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_GRUNT_33, TRAINER_AMBER, TRAINER_CORY, TRAINER_MOTO, TRAINER_ALEC, ROUTE118),
    ...
    [REMATCH_LOLA] = REMATCH(TRAINER_PRISCILLA, TRAINER_PRISCILLA, TRAINER_PRISCILLA, TRAINER_PRISCILLA, TRAINER_PRISCILLA, ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_RICKY_1, TRAINER_RICKY_2, TRAINER_RICKY_3, TRAINER_MICKY, TRAINER_JORDAN, ROUTE109),
    ...
    [REMATCH_WILTON] = REMATCH(TRAINER_DILLON, TRAINER_EVAN, TRAINER_OSCAR, TRAINER_AUBREE, TRAINER_HUNTER, ROUTE111),
    [REMATCH_VALERIE] = REMATCH(TRAINER_VALERIE_1, TRAINER_VALERIE_2, TRAINER_VALERIE_3, TRAINER_VALERY, TRAINER_SHEILA, MT_PYRE_6F),
    ...
    [REMATCH_JESSICA] = REMATCH(TRAINER_ARIANA_1, TRAINER_ARIANA_2, TRAINER_MARIK, TRAINER_MONIKA, TRAINER_ROMAN, ROUTE121),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_ALYSSA, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MT_CHIMNEY),
