...
const u32 gMonFrontPic_Lotuga[] = INCBIN_U32("graphics/pokemon/lotuga/anim_front.4bpp.lz");
const u32 gMonFrontPic_Vertuga[] = INCBIN_U32("graphics/pokemon/vertuga/anim_front.4bpp.lz");
