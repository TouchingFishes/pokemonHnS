...
const struct TrainerBall gTrainerBallTable[] = {
    ...
    {TRAINER_CLASS_CHANNELER, ITEM_POKE_BALL},
    {TRAINER_CLASS_ELDER, ITEM_TIMER_BALL},
    {TRAINER_CLASS_SCIENTIST, ITEM_REPEAT_BALL},
    {TRAINER_CLASS_TAMER, ITEM_SAFARI_BALL},
    {TRAINER_CLASS_SKIER, ITEM_FAST_BALL},
    {TRAINER_CLASS_GAMBLER, ITEM_PREMIER_BALL},
    {TRAINER_CLASS_CASINO_ACE, ITEM_PREMIER_BALL},
    {TRAINER_CLASS_RILEY, ITEM_ULTRA_BALL},
    {TRAINER_CLASS_PAINTER, ITEM_POKE_BALL},
    {TRAINER_CLASS_BUCK, ITEM_ULTRA_BALL},
    {TRAINER_CLASS_IRIS, ITEM_ULTRA_BALL},
    {TRAINER_CLASS_CYNTHIA, ITEM_LUXURY_BALL},
    {TRAINER_CLASS_STEVEN, ITEM_POKE_BALL},
    {TRAINER_CLASS_SORA, ITEM_POKE_BALL},
    {0xFF, ITEM_POKE_BALL},
};
...
const struct TrainerMoney gTrainerMoneyTable[] =
{
    ...
    {TRAINER_CLASS_CHANNELER, 6},
    {TRAINER_CLASS_EX_ELITE, 20},
    {TRAINER_CLASS_ELDER, 8},
    {TRAINER_CLASS_SCIENTIST, 10},
    {TRAINER_CLASS_TAMER, 10},
    {TRAINER_CLASS_SKIER, 8},
    {TRAINER_CLASS_GAMBLER, 6},
    {TRAINER_CLASS_CASINO_ACE, 30},
    {TRAINER_CLASS_RILEY, 12},
    {TRAINER_CLASS_PAINTER, 6},
    {TRAINER_CLASS_BUCK, 12},
    {TRAINER_CLASS_IRIS, 50},
    {TRAINER_CLASS_CYNTHIA, 50},
    {TRAINER_CLASS_STEVEN, 50},
    {TRAINER_CLASS_SORA, 12},
...
static u8 CreateNPCTrainerParty(struct Pokemon *party, u16 trainerNum, bool8 firstTrainer)
{
                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (i = 0; i < monsCount; i++)
        {
            ...
            case F_TRAINER_PARTY_CUSTOM_MOVESET | F_TRAINER_PARTY_HELD_ITEM | F_TRAINER_PARTY_LEVEL_SCALED:
            {
                ...
                SetMonData(&party[i], MON_DATA_HELD_ITEM, &partyData[i].heldItem);
                    ...
                    if (gSaveBlock2Ptr->optionsDifficulty == 2) //only in hard mode
                    {
                        ...
                        if (partyData[i].species == SPECIES_EELEKTROSS && gTrainers[trainerNum].trainerPic == TRAINER_PIC_ELITE_FOUR_WILL
                        && gTrainers[trainerNum].trainerClass == TRAINER_CLASS_ELITE_FOUR)
                        {
            ...
            {
                const struct TrainerMonNoItemCustomMovesAbilities *partyData = gTrainers[trainerNum].party.NoItemCustomMovesAbility;
                ...
                {
                    species = GetSpeciesRandomSeeded(partyData[i].species, TX_RANDOM_T_TRAINER, trainerNum);
                    CreateMon(&party[i], species, GetScaledLevel(ResolveTrainerMonLevel(partyData[i].lvl)), fixedIV, TRUE, personalityValue, OT_ID_RANDOM_NO_SHINY, 0);
                }
                else
            ...
            {
                const struct TrainerMonItemCustomMovesAbilities *partyData = gTrainers[trainerNum].party.ItemCustomMovesAbility;
